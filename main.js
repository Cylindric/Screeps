...
module.exports.loop = function() {
  ...
  for (var i in Game.spawns) {
    ...
    var neededCreeps = _.sum(needs);
    if (neededCreeps > 0 && map.isSpawnReserved(spawn.room) === false) {
      console.log("Detected missing creeps; reserving spawn...")
      map.reserveSpawn(spawn.room, true);
    } else if (neededCreeps === 0 && map.isSpawnReserved(spawn.room) === true) {
    ...
    msg += 'Spawn Energy: ' + map.getPowerLevel(spawn.room);
    console.log(msg);
